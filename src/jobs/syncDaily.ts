...
(async () => {
  ...
  await syncService.syncDailyRevenueToEconomic(startDate, endDate);
  await syncService.syncDailyRefundsToEconomic(startDate, endDate);
  await syncService.syncDailyPayoutsToEconomic(startDate, endDate);
})();
